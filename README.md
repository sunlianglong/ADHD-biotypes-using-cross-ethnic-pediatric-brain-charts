...
## **Data**
1. Demographic and clinical information for ADHD subtypes: *ADHD_subtypes_demographic.csv* and *ADHD_Clinic_Info.xlsx*

2. Follow-up treatment information for ADHD subtypes: *ADHD_subtypes_treatment.csv*
